...
exports.login = async (req, res) => {
  ...
  const session = await authServices.createSessionForUser(
    user,
    req.ip,
    req.get("User-Agent")
  );

  res.cookie(cookieConfig.refreshTokenName, session.refreshToken, {
...
exports.logout = async (req, res) => {
  ...
  res.clearCookie(cookieConfig.refreshTokenName, cookieConfig.refreshToken);
